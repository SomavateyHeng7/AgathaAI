      ...
      <section className="px-6 py-20 text-center">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="flex items-center justify-center gap-4">
            <Link
              href="/signup"
              className="inline-block rounded-lg bg-white px-8 py-4 text-lg font-semibold text-gray-900 hover:bg-gray-100 transition-all"
            >
              Start free trial
            </Link>
            <Link
              href="/signin"
              className="inline-block rounded-lg border border-gray-700 px-8 py-4 text-lg font-semibold text-white hover:bg-gray-800 transition-all"
            >
              View demo
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-gray-800 bg-gray-900 p-8">
              ...
              <h3 className="mb-2 text-xl font-semibold text-white">Enterprise Security</h3>
              <p className="text-gray-400">
            ...
            <div className="rounded-2xl border border-gray-800 bg-gray-900 p-8">
              ...
              <h3 className="mb-2 text-xl font-semibold text-white">Auto-Scaling</h3>
              <p className="text-gray-400">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="rounded-2xl border border-gray-800 bg-gray-900 p-8">
              ...
              <Link
                href="/signup"
                className="block w-full rounded-lg border border-gray-700 py-3 text-center font-semibold text-white hover:bg-gray-800 transition-all"
              >
                Get started
              </Link>
            </div>

            <div className="rounded-2xl border-2 border-blue-500 bg-gray-900 p-8">
              ...
              <Link
                href="/signup"
                className="block w-full rounded-lg bg-white py-3 text-center font-semibold text-gray-900 hover:bg-gray-100 transition-all"
              >
                Get started
              </Link>
            </div>
